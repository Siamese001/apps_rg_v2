...
|---:|---|---|---|---|---|---|---|---|
| 1 | `u0_ingress` | `NOT_OBSERVED` | `1c21c2273f11d8366f82d787` | `False` | `CORRELATED_ONLY` | The runs differ here, but the available artifacts do not prove this targeting change caused the failed sentence shape. | `-` | `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry2_20260809\e2e_20260809T053712Z_ebdcf040\ingress_raw.json` |
| 2 | `u0_payload` | `NOT_OBSERVED` | `426623c718959d6f5906a6d5` | `False` | `CORRELATED_ONLY` | The runs differ here, but the available artifacts do not prove this targeting change caused the failed sentence shape. | `-` | `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry2_20260809\e2e_20260809T053712Z_ebdcf040\u0_receipt.json` |
