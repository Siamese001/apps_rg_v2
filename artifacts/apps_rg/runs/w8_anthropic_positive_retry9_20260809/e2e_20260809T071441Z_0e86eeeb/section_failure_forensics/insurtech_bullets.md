...
- failed_gate_ids: `x2_insurtech_bullets_source_fact_ids_supported, x2_claim_ledger_claim_text_non_empty, x2_insurtech_bullets_display_text_proof_authorized, x2_insurtech_bullets_runtime_real_llm, x2_insurtech_bullets_bullet_count_3, x2_resume_graph_claim_binding`
...
| Judges | `NOT_OBSERVED` | `gemini_pro: —/5 vs — FAIL` |
