...
| Fault | `L2_EXECUTION_ERROR:RuntimeError:FAILED_MODULAR_R4: decisive='FAIL' failure='fatal_lane_recipe_policy:ibm_narrative:EXECUTED_X3_BLOCK; executive_summary:EXECUTED_X3_BLOCK_FINAL_MATERIALIZED_ACCEPTANCE; headline:EXECUTED_X3_BLOCK' schema_ok=False lane_ok=False` |
...
| `mandatory_resume_text_inline_present` | `FAIL` | `{'artifact': {'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7528, 'sha256': 'a1e2c6db034b24b5ca515cf95229d091ff7e2d18319a7f1addfb53c698490b7d'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=ibm_narrative,executive_summary,headline,final_resume_aggregation']}` |
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 21796097, 'sha256': '1a263fd4c94f7247592292168f4b4ca17bbf8fa7dfa728353e2609b3ea5a53a7'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=ibm_narrative,executive_summary,headline,final_resume_aggregation']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 5096, 'sha256': '903d6713fd541078ea3f711ef59f107b5f927c057464bcf591c0b1d3e523ad4c'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=ibm_narrative,executive_summary,headline,final_resume_aggregation']}` |
...
| `mandatory_bcg_p0_p1_px_recommendations_locked` | `FAIL` | `{'title': 'BCG Executive Output - apps_rg Run', 'section_order': ['executive_answer', 'p0_p1_px_recommendations', 'board_level_readout', 'issue_tree', 'recommended_next_move', 'evidence_map'], 'priorities': ['P0'], 'truth_errors': ['bcg.forensics.incomplete_artifact:executive_summary', 'bcg.forensics.incomplete_artifact:final_resume_aggregation', 'bcg.forensics.incomplete_artifact:headline', 'bcg.forensics.incomplete_artifact:ibm_narrative', 'bcg.issue_tree.incomplete_forensic_artifact:ibm_narrative', 'bcg.issue_tree.incomplete_forensic_artifact:executive_summary', 'bcg.issue_tree.incomplete_forensic_artifact:headline']}` |
...
| `mandatory_resume_docx_inline_json_present` | `FAIL` | `{'title': 'Resume DOCX Full Version Inline', 'text_chars': 522, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=ibm_narrative,executive_summary,headline,final_resume_aggregation']}` |
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `FAIL` | `{'required': True, 'failed_section_count': 4, 'artifact_dir': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics', 'missing_or_incomplete': [{'section_id': 'ibm_narrative', 'json_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/ibm_narrative.json', 'md_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/ibm_narrative.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'executive_summary', 'json_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/executive_summary.json', 'md_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/executive_summary.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'headline', 'json_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/headline.json', 'md_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/headline.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'final_resume_aggregation', 'json_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/final_resume_aggregation.json', 'md_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/final_resume_aggregation.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'aggregation_downstream', 'baseline_confidence': 'pinned_contract_invalid'}]}` |
...
|---:|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | `research_briefing_input` | `FRESH_APPS_RESEARCH` | `miss` | `skipped` | `YES` | `True` | `external_openai` | `gpt-5.6-terra` | `N/A` | `N/A` | `N/A` | `BRIEFING_PRESENT:RUN_SPECIFIC` | `N/A` | `N/A` | `N/A` | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>PASS; judge=gemini-3.6-flash</code></span> | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>X3D_ALLOW_FINISH; X1=PASS</code></span> | <span style="display:inline-block; min-width:44ch; white-space:normal"><code>auto_research_internal=True; research_delegation_executed=True; source=RUN_SPECIFIC; digest=3fe5f7d6e1c422194eef89518e32f4914472b289e6861113f41cba6701a25ff8;<br>ref=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry6_20260809\e2e_20260809T055825Z_cfcbf4fc\apps_research\runs\r-73ff483d7ddda9402be67a57\briefing.md;<br>target=Anthropic / Manager of Applied AI Architecture, Partnerships; briefing_text_chars=7670</code></span> | `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry6_20260809\e2e_20260809T055825Z_cfcbf4fc\apps_research\runs\r-73ff483d7ddda9402be67a57\briefing.md` | `N/A` |
...
| `ibm_narrative` | `ran_real_llm` | `X3_BLOCK` | `FAIL` | `FAIL` | `REAL_LLM` | `x2_ibm_narrative_claim_theme_coverage` | `modular_r4/sections/ibm_narrative/ibm_narrative_output.txt` |
...
| `executive_summary` | `ran_real_llm` | `X3_BLOCK_FINAL_MATERIALIZED_ACCEPTANCE` | `FAIL` | `PASS` | `REAL_LLM` | `x2_resume_graph_claim_binding` | `modular_r4/sections/executive_summary/resume_display_text.txt` |
| `headline` | `ran_real_llm` | `X3_BLOCK` | `FAIL` | `FAIL` | `REAL_LLM` | `x2_headline_executive_abstraction_floor, x2_headline_technical_specificity_floor_met` | `modular_r4/sections/headline/headline_output.txt` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 21796097 | `1a263fd4c94f7247592292168f4b4ca17bbf8fa7dfa728353e2609b3ea5a53a7` |
| Rendered final resume text | `FINAL_RESUME_OUTPUT.txt` | `EXISTS_UNAUTHORIZED` | 7528 | `a1e2c6db034b24b5ca515cf95229d091ff7e2d18319a7f1addfb53c698490b7d` |
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 5096 | `903d6713fd541078ea3f711ef59f107b5f927c057464bcf591c0b1d3e523ad4c` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/modular_r4/final_resume_assembly/final_resume.json` |
| `final_resume_rendered_text_present` | `PASS` | `{'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7528, 'sha256': 'a1e2c6db034b24b5ca515cf95229d091ff7e2d18319a7f1addfb53c698490b7d'}` |
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 5096, 'sha256': '903d6713fd541078ea3f711ef59f107b5f927c057464bcf591c0b1d3e523ad4c'}` |
| `final_resume_rendered_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 237, 'ENGINEERING & PLATFORM COMPETENCIES': 1246, 'PROFESSIONAL EXPERIENCE': 2876, 'EDUCATION': 6955, 'CERTIFICATIONS': 7119}` |
| `final_resume_docx_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 235, 'ENGINEERING & PLATFORM COMPETENCIES': 1243, 'PROFESSIONAL EXPERIENCE': 2872, 'EDUCATION': 6945, 'CERTIFICATIONS': 7108}` |
| `final_resume_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [2901, 2958], 'ibm': [4462, 4476], 'insurtech': [5436, 5489], 'ey': [5819, 5845], 'early_career': [6448, 6513]}}` |
| `final_resume_docx_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [2896, 2953], 'ibm': [4456, 4470], 'insurtech': [5429, 5482], 'ey': [5811, 5837], 'early_career': [6439, 6504]}}` |
| `final_resume_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6965, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 7050}}` |
| `final_resume_docx_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6955, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 7040}}` |
| `final_resume_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 7148, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 7207, 'Certified Solutions Architect – Professional, AWS, 2023': 7261, 'Fellow of the Society of Actuaries, 2010': 7317}}` |
| `final_resume_docx_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 7137, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 7196, 'Certified Solutions Architect – Professional, AWS, 2023': 7250, 'Fellow of the Society of Actuaries, 2010': 7306}}` |
...
| `unify_bullets` | `Anthropic Claude` | `claude-sonnet-5` | `MODEL_BACKED_PASS` | 0.79 | 0.72 | `PASS` | `model_backed_pass_provider_keys=gemini_pro,anthropic_claude,gemini_pro` |
| `unify_bullets` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `MODEL_BACKED_PASS` | 5 | 4 | `PASS` | `model_backed_pass_provider_keys=gemini_pro,anthropic_claude,gemini_pro` |
...
| `insurtech_bullets` | `Anthropic Claude` | `claude-sonnet-5` | `MODEL_BACKED_PASS` | 0.81 | 0.72 | `PASS` | `model_backed_pass_provider_keys=gemini_pro,anthropic_claude` |
...
| `executive_summary` | `OpenAI ChatGPT` | `gpt-5.6-sol` | `MODEL_BACKED_PASS` | 4.5 | 4 | `PASS` | `model_backed_pass_provider_keys=gemini_pro,openai_chatgpt` |
...
| `headline` | `OpenAI ChatGPT` | `gpt-5.6-sol` | `MODEL_BACKED_FAIL` | 3.4 | 4 | `FAIL` | `decisive_judge_failures=openai_chatgpt, model_backed_pass_provider_keys=gemini_pro` |
...
2. `executive_summary` - Evidence mapping failure: visible content was not fully backed by source facts or graph lineage.
...
3. `headline` - Headline executive positioning contract failure: vendor/tool proof terms reached display without an executive abstraction segment.
...
- Artifact directory: `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics`
- Baseline confidence: `pinned_contract_invalid`

| Section | Failure type | Complete | Comparison | JSON | MD |
|---|---|---:|---:|---|---|
| `ibm_narrative` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/ibm_narrative.json` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/ibm_narrative.md` |
| `executive_summary` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/executive_summary.json` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/executive_summary.md` |
| `headline` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/headline.json` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/headline.md` |
| `final_resume_aggregation` | `aggregation_downstream` | `False` | `False` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/final_resume_aggregation.json` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry6_20260809/e2e_20260809T055825Z_cfcbf4fc/section_failure_forensics/final_resume_aggregation.md` |
...
run_root=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry6_20260809\e2e_20260809T055825Z_cfcbf4fc
status=BLOCKED
reason=outcome_authorized_false; final_resume_output_status=FAIL; failed_final_resume_gates=final_resume_no_gap_markers; x3_blocked=ibm_narrative,executive_summary,headline,final_resume_aggregation
