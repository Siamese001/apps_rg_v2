...
- failed_gate_ids: `x2_ibm_narrative_claim_theme_coverage`
...
The section's final materialized artifact did not pass x2_ibm_narrative_claim_theme_coverage.
...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `0e91f48bacb7a551c5c8d2a00912a860974e4eb5b03ed4316ecc56ac36c0114e` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry6_20260809\e2e_20260809T055825Z_cfcbf4fc\modular_r4\sections\ibm_narrative\ibm_narrative_output.txt` |
...
- Bind the failed gate evidence (`x2_ibm_narrative_claim_theme_coverage`) to the producer/parser contract that emitted the artifact.
