...
- failed_gate_ids: `x2_headline_xyz_literal_grounding, x2_resume_graph_claim_binding`
...
The section's final materialized artifact did not pass x2_headline_xyz_literal_grounding, x2_resume_graph_claim_binding.
...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `f0d10806e02a2eae6b99128ed66299381276f60721b26e0200e95e0993349cd9` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry32_20260809\e2e_20260809T114813Z_d0905b28\modular_r4\sections\headline\headline_output.txt` |
| X2 / X3 | `NOT_OBSERVED` / `NOT_OBSERVED` | `FAIL` / `X3_BLOCK` |
| Judges | `NOT_OBSERVED` | `Google Gemini 3.6 Flash `gemini-3.6-flash`: 5/5 vs 4 PASS; OpenAI ChatGPT `gpt-5.6-sol`: 4.5/5 vs 4 PASS` |

## Required Fix

- Make `headline` gate final displayed output, not intermediate provider output.
- Bind the failed gate evidence (`x2_headline_xyz_literal_grounding, x2_resume_graph_claim_binding`) to the producer/parser contract that emitted the artifact.
