...
- failed_gate_ids: `x2_exec_summary_no_mechanism_inventory`
...
The section's final materialized artifact did not pass x2_exec_summary_no_mechanism_inventory.
...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `e95ed079e1aea44ccb978a082eac5abf74dadf1fd28308af40a49f7dfbff2ed3` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry32_20260809\e2e_20260809T114813Z_d0905b28\modular_r4\sections\executive_summary\resume_display_text.txt` |
...
- Bind the failed gate evidence (`x2_exec_summary_no_mechanism_inventory`) to the producer/parser contract that emitted the artifact.
