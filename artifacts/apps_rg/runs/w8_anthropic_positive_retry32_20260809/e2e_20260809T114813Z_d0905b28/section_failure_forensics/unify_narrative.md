...
- failed_gate_ids: `x2_no_companion_ngram_copy`
...
The section's final materialized artifact did not pass x2_no_companion_ngram_copy.
...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `78977e0b3e933f05982886d2530a3a01a3695c9f9dc1e91d72a4f625414f5631` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry32_20260809\e2e_20260809T114813Z_d0905b28\modular_r4\sections\unify_narrative\unify_narrative_output.txt` |
| X2 / X3 | `NOT_OBSERVED` / `NOT_OBSERVED` | `FAIL` / `X3_BLOCK` |
| Judges | `NOT_OBSERVED` | `Google Gemini 3.6 Flash `gemini-3.6-flash`: 5/5 vs 4 PASS` |

## Required Fix

- Make `unify_narrative` gate final displayed output, not intermediate provider output.
- Bind the failed gate evidence (`x2_no_companion_ngram_copy`) to the producer/parser contract that emitted the artifact.
