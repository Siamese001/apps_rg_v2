...
- First observed divergence: `u0_ingress` - Neither run recorded evidence for this stage.
...
|---:|---|---|---|---|---|---|---|---|
| 1 | `u0_ingress` | `NOT_OBSERVED` | `NOT_OBSERVED` | `False` | `EVIDENCE_GAP` | Neither run recorded evidence for this stage. | `-` | `C:\Git\Agentic-Workflow-FRESH-worktrees\codex-apps-rg-source-refreeze\artifacts\apps_rg\runs\source_c03_s2r3_role_context_20260720_r1\full_s2\e2e_20260720T215844Z_3459e759\ingress_raw.json` |
| 2 | `u0_payload` | `NOT_OBSERVED` | `NOT_OBSERVED` | `False` | `EVIDENCE_GAP` | Neither run recorded evidence for this stage. | `-` | `C:\Git\Agentic-Workflow-FRESH-worktrees\codex-apps-rg-source-refreeze\artifacts\apps_rg\runs\source_c03_s2r3_role_context_20260720_r1\full_s2\e2e_20260720T215844Z_3459e759\u0_receipt.json` |
