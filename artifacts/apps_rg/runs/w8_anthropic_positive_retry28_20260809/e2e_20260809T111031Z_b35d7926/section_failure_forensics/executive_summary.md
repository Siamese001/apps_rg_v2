...
- failed_gate_ids: `x2_exec_summary_speculative_capstone_zero`
...
The section's final materialized artifact did not pass x2_exec_summary_speculative_capstone_zero.
...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `f573c213ff5998ca46a4792123c64431bb779cceca6f4b8d6a8f88d180f07750` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry28_20260809\e2e_20260809T111031Z_b35d7926\modular_r4\sections\executive_summary\resume_display_text.txt` |
...
- Bind the failed gate evidence (`x2_exec_summary_speculative_capstone_zero`) to the producer/parser contract that emitted the artifact.
