...
Generated: `2026-07-21T09:48:58Z`
Run root: `@C:\Git\Agentic-Workflow-FRESH-worktrees\codex-apps-rg-source-refreeze\artifacts\apps_rg\runs\s2g1_r1\e2e_20260721T094757Z_e86ae693`
...
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 7087, 'sha256': '0ed18c88a9e6e664ac6a78e24421c8360552ca866874abc928f3ef28745bf667'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 37799, 'sha256': 'b88f8507e08b90cc87998eabe896635abc0f01b126d88f86c45ce4af6889071f'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers']}` |
...
| `mandatory_resume_docx_inline_json_present` | `FAIL` | `{'title': 'Resume DOCX Full Version Inline', 'text_chars': 424, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers']}` |
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `FAIL` | `{'required': True, 'failed_section_count': 1, 'artifact_dir': 'artifacts/apps_rg/runs/s2g1_r1/e2e_20260721T094757Z_e86ae693/section_failure_forensics', 'missing_or_incomplete': [{'section_id': 'whole_run', 'json_path': 'artifacts/apps_rg/runs/s2g1_r1/e2e_20260721T094757Z_e86ae693/section_failure_forensics/whole_run.json', 'md_path': 'artifacts/apps_rg/runs/s2g1_r1/e2e_20260721T094757Z_e86ae693/section_failure_forensics/whole_run.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'mandatory_output_authorization_block', 'baseline_confidence': 'pinned_baseline_unavailable'}]}` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 7087 | `0ed18c88a9e6e664ac6a78e24421c8360552ca866874abc928f3ef28745bf667` |
...
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 37799 | `b88f8507e08b90cc87998eabe896635abc0f01b126d88f86c45ce4af6889071f` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runs/s2g1_r1/e2e_20260721T094757Z_e86ae693/modular_r4/final_resume_assembly/final_resume.json` |
...
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 37799, 'sha256': 'b88f8507e08b90cc87998eabe896635abc0f01b126d88f86c45ce4af6889071f'}` |
...
- Artifact directory: `artifacts/apps_rg/runs/s2g1_r1/e2e_20260721T094757Z_e86ae693/section_failure_forensics`
- Baseline confidence: `pinned_baseline_unavailable`

| Section | Failure type | Complete | Comparison | JSON | MD |
|---|---|---:|---:|---|---|
| `whole_run` | `mandatory_output_authorization_block` | `False` | `False` | `artifacts/apps_rg/runs/s2g1_r1/e2e_20260721T094757Z_e86ae693/section_failure_forensics/whole_run.json` | `artifacts/apps_rg/runs/s2g1_r1/e2e_20260721T094757Z_e86ae693/section_failure_forensics/whole_run.md` |
...
run_root=C:\Git\Agentic-Workflow-FRESH-worktrees\codex-apps-rg-source-refreeze\artifacts\apps_rg\runs\s2g1_r1\e2e_20260721T094757Z_e86ae693
status=BLOCKED
