...
Generated: `2026-08-09T07:06:21Z`
Run root: `@C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry8_20260809\e2e_20260809T065510Z_3f589fcd`
...
| Fault | `L2_EXECUTION_ERROR:RuntimeError:FAILED_MODULAR_R4: decisive='FAIL' failure='fatal_lane_recipe_policy:ibm_narrative:EXECUTED_X3_BLOCK; headline:EXECUTED_X3_BLOCK' schema_ok=False lane_ok=False` |
...
| `mandatory_resume_text_inline_present` | `FAIL` | `{'artifact': {'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7418, 'sha256': 'b3f774c7ae3477e585be1127263fb752faf5c375631edb708eecbeb5ca16e7c5'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=ibm_narrative,headline,final_resume_aggregation']}` |
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 21801528, 'sha256': 'cf5437f7e4b4cbab17fb5eb99d80e05e6108ae5115f0a3e3d5f8c7cd494fe98f'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=ibm_narrative,headline,final_resume_aggregation']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 5106, 'sha256': '079fde7dad9faf43ce10c306f96ce96e780776f0a46055a99f413c4ba7bf89b2'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=ibm_narrative,headline,final_resume_aggregation']}` |
...
| `mandatory_bcg_p0_p1_px_recommendations_locked` | `FAIL` | `{'title': 'BCG Executive Output - apps_rg Run', 'section_order': ['executive_answer', 'p0_p1_px_recommendations', 'board_level_readout', 'issue_tree', 'recommended_next_move', 'evidence_map'], 'priorities': ['P0'], 'truth_errors': ['bcg.forensics.incomplete_artifact:final_resume_aggregation', 'bcg.forensics.incomplete_artifact:headline', 'bcg.forensics.incomplete_artifact:ibm_narrative', 'bcg.issue_tree.incomplete_forensic_artifact:ibm_narrative', 'bcg.issue_tree.incomplete_forensic_artifact:headline']}` |
...
| `mandatory_resume_docx_inline_json_present` | `FAIL` | `{'title': 'Resume DOCX Full Version Inline', 'text_chars': 504, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=ibm_narrative,headline,final_resume_aggregation']}` |
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `FAIL` | `{'required': True, 'failed_section_count': 3, 'artifact_dir': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics', 'missing_or_incomplete': [{'section_id': 'ibm_narrative', 'json_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/ibm_narrative.json', 'md_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/ibm_narrative.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'headline', 'json_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/headline.json', 'md_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/headline.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'final_resume_aggregation', 'json_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/final_resume_aggregation.json', 'md_path': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/final_resume_aggregation.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'aggregation_downstream', 'baseline_confidence': 'pinned_contract_invalid'}]}` |
...
|---:|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | `research_briefing_input` | `FRESH_APPS_RESEARCH` | `miss` | `skipped` | `YES` | `True` | `external_openai` | `gpt-5.6-terra` | `N/A` | `N/A` | `N/A` | `BRIEFING_PRESENT:RUN_SPECIFIC` | `N/A` | `N/A` | `N/A` | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>PASS; judge=gemini-3.6-flash</code></span> | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>X3D_ALLOW_FINISH; X1=PASS</code></span> | <span style="display:inline-block; min-width:44ch; white-space:normal"><code>auto_research_internal=True; research_delegation_executed=True; source=RUN_SPECIFIC; digest=c859e9dd87cc2f0886591a3edcf4a22868838cac7f18319f6691f8f20be7b1bd;<br>ref=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry8_20260809\e2e_20260809T065510Z_3f589fcd\apps_research\runs\r-3789e66886844a7b8cc94e81\briefing.md;<br>target=Anthropic / Manager of Applied AI Architecture, Partnerships; briefing_text_chars=7954</code></span> | `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry8_20260809\e2e_20260809T065510Z_3f589fcd\apps_research\runs\r-3789e66886844a7b8cc94e81\briefing.md` | `N/A` |
...
| `ibm_narrative` | `ran_real_llm` | `X3_BLOCK` | `FAIL` | `FAIL` | `REAL_LLM` | `x2_ibm_narrative_mechanisms_supported_by_cited_companion_bullets` | `modular_r4/sections/ibm_narrative/ibm_narrative_output.txt` |
...
| `headline` | `ran_real_llm` | `X3_BLOCK` | `PASS` | `PASS` | `REAL_LLM` | `-` | `modular_r4/sections/headline/headline_output.txt` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 21801528 | `cf5437f7e4b4cbab17fb5eb99d80e05e6108ae5115f0a3e3d5f8c7cd494fe98f` |
| Rendered final resume text | `FINAL_RESUME_OUTPUT.txt` | `EXISTS_UNAUTHORIZED` | 7418 | `b3f774c7ae3477e585be1127263fb752faf5c375631edb708eecbeb5ca16e7c5` |
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 5106 | `079fde7dad9faf43ce10c306f96ce96e780776f0a46055a99f413c4ba7bf89b2` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/modular_r4/final_resume_assembly/final_resume.json` |
| `final_resume_rendered_text_present` | `PASS` | `{'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7418, 'sha256': 'b3f774c7ae3477e585be1127263fb752faf5c375631edb708eecbeb5ca16e7c5'}` |
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 5106, 'sha256': '079fde7dad9faf43ce10c306f96ce96e780776f0a46055a99f413c4ba7bf89b2'}` |
| `final_resume_rendered_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 259, 'ENGINEERING & PLATFORM COMPETENCIES': 1198, 'PROFESSIONAL EXPERIENCE': 2828, 'EDUCATION': 6845, 'CERTIFICATIONS': 7009}` |
| `final_resume_docx_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 257, 'ENGINEERING & PLATFORM COMPETENCIES': 1195, 'PROFESSIONAL EXPERIENCE': 2824, 'EDUCATION': 6835, 'CERTIFICATIONS': 6998}` |
| `final_resume_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [2853, 2910], 'ibm': [4480, 4494], 'insurtech': [5326, 5379], 'ey': [5709, 5735], 'early_career': [6338, 6403]}}` |
| `final_resume_docx_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [2848, 2905], 'ibm': [4474, 4488], 'insurtech': [5319, 5372], 'ey': [5701, 5727], 'early_career': [6329, 6394]}}` |
| `final_resume_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6855, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 6940}}` |
| `final_resume_docx_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6845, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 6930}}` |
| `final_resume_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 7038, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 7097, 'Certified Solutions Architect – Professional, AWS, 2023': 7151, 'Fellow of the Society of Actuaries, 2010': 7207}}` |
| `final_resume_docx_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 7027, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 7086, 'Certified Solutions Architect – Professional, AWS, 2023': 7140, 'Fellow of the Society of Actuaries, 2010': 7196}}` |
...
| `unify_bullets` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `MODEL_BACKED_PASS` | 5 | 4 | `PASS` | `model_backed_pass_provider_keys=gemini_pro,anthropic_claude,gemini_pro` |
| `ibm_bullets` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `MODEL_BACKED_PASS` | 4.8 | 4 | `PASS` | `model_backed_pass_provider_keys=gemini_pro,anthropic_claude` |
| `ibm_bullets` | `Anthropic Claude` | `claude-sonnet-5` | `MODEL_BACKED_PASS` | 0.8 | 0.72 | `PASS` | `model_backed_pass_provider_keys=gemini_pro,anthropic_claude` |
...
| `ey_bullets` | `Anthropic Claude` | `claude-sonnet-5` | `MODEL_BACKED_PASS` | 0.8 | 0.72 | `PASS` | `model_backed_pass_provider_keys=gemini_pro,anthropic_claude` |
...
| `headline` | `OpenAI ChatGPT` | `gpt-5.6-sol` | `MODEL_BACKED_FAIL` | 3.3 | 4 | `FAIL` | `decisive_judge_failures=openai_chatgpt, model_backed_pass_provider_keys=gemini_pro` |
| `final_resume_aggregation` | `-` | `-` | `no_judge_rows_observed` |  |  | `UNKNOWN` | `-` |

## RCA Findings

1. `ibm_narrative` - Deterministic gate failure.
...
2. `headline` - X1D decisive judge failure: model-backed judge rejected section product quality.
   ...
   - Evidence: `OpenAI ChatGPT \| gpt-5.6-sol \| MODEL_BACKED_FAIL \| score=3.3/4`
   - Causal allocation:
     ...
     - Allocation rows:
       - `Claim ledger normalization` / `PRIMARY` / `45%`: OpenAI ChatGPT | gpt-5.6-sol | MODEL_BACKED_FAIL | score=3.3/4 Evidence: `parsed_output.json, claim_ledger.json, x1d_llm_judge_outputs.json`. Required work: Preserve valid source_fact_ids from parsed narrative claim_ledger rows when publishing the single-sentence role-episode ledger.
...
- Artifact directory: `artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics`
- Baseline confidence: `pinned_contract_invalid`

| Section | Failure type | Complete | Comparison | JSON | MD |
|---|---|---:|---:|---|---|
| `ibm_narrative` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/ibm_narrative.json` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/ibm_narrative.md` |
| `headline` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/headline.json` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry8_20260809/e2e_20260809T065510Z_3f589fcd/section_failure_forensics/headline.md` |
...
run_root=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry8_20260809\e2e_20260809T065510Z_3f589fcd
status=BLOCKED
reason=outcome_authorized_false; final_resume_output_status=FAIL; failed_final_resume_gates=final_resume_no_gap_markers; x3_blocked=ibm_narrative,headline,final_resume_aggregation
