...
| Fault | `L2_EXECUTION_ERROR:RuntimeError:FAILED_MODULAR_R4: decisive='FAIL' failure='fatal_lane_recipe_policy:competencies:EXECUTED_X3_BLOCK; ibm_bullets:EXECUTED_X3_BLOCK; ey_bullets:EXECUTED_X3_BLOCK; ibm_narrative:upstream_not_finalized; ey_narrative:upstream_not_finalized' schema_ok=False lane_ok=False` |
...
| `mandatory_resume_text_inline_present` | `FAIL` | `{'artifact': {'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7119, 'sha256': '7285c3c5224bd045ff832ff4dbdc927464aaf6ecb7e1667fb9a863a0d55e3018'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,ibm_bullets,ey_bullets,final_resume_aggregation', 'pre_run_blocked=ibm_narrative,ey_narrative']}` |
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 19101631, 'sha256': '52d89e223d7d52e390a9cebb110a2e3b36a9087faf1c0e5c4ab1f1a9ad1ac530'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,ibm_bullets,ey_bullets,final_resume_aggregation', 'pre_run_blocked=ibm_narrative,ey_narrative']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 4992, 'sha256': '2bfdd4123bef7d1c5120046de1767eb73368512a4230df9f1bc4751dcf864077'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,ibm_bullets,ey_bullets,final_resume_aggregation', 'pre_run_blocked=ibm_narrative,ey_narrative']}` |
...
| `mandatory_resume_docx_inline_json_present` | `FAIL` | `{'title': 'Resume DOCX Full Version Inline', 'text_chars': 562, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,ibm_bullets,ey_bullets,final_resume_aggregation', 'pre_run_blocked=ibm_narrative,ey_narrative']}` |
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `PASS` | `{'required': True, 'failed_section_count': 6, 'artifact_dir': 'artifacts/apps_rg/runs/w8_anthropic_positive_retry16_20260809/e2e_20260809T090140Z_6b8a9546/section_failure_forensics', 'missing_or_incomplete': []}` |
...
|---|---|---|---|---|---|---|---|
| `competencies` | `ran_real_llm` | `X3_BLOCK` | `FAIL` | `FAIL` | `REAL_LLM` | `x2_required_capability_families_covered, x2_resume_graph_claim_binding` | `modular_r4/sections/competencies/competencies_display.txt` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 19101631 | `52d89e223d7d52e390a9cebb110a2e3b36a9087faf1c0e5c4ab1f1a9ad1ac530` |
| Rendered final resume text | `FINAL_RESUME_OUTPUT.txt` | `EXISTS_UNAUTHORIZED` | 7119 | `7285c3c5224bd045ff832ff4dbdc927464aaf6ecb7e1667fb9a863a0d55e3018` |
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 4992 | `2bfdd4123bef7d1c5120046de1767eb73368512a4230df9f1bc4751dcf864077` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry16_20260809/e2e_20260809T090140Z_6b8a9546/modular_r4/final_resume_assembly/final_resume.json` |
| `final_resume_rendered_text_present` | `PASS` | `{'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7119, 'sha256': '7285c3c5224bd045ff832ff4dbdc927464aaf6ecb7e1667fb9a863a0d55e3018'}` |
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 4992, 'sha256': '2bfdd4123bef7d1c5120046de1767eb73368512a4230df9f1bc4751dcf864077'}` |
| `final_resume_rendered_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 236, 'ENGINEERING & PLATFORM COMPETENCIES': 1215, 'PROFESSIONAL EXPERIENCE': 2741, 'EDUCATION': 6545, 'CERTIFICATIONS': 6709}` |
| `final_resume_docx_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 234, 'ENGINEERING & PLATFORM COMPETENCIES': 1212, 'PROFESSIONAL EXPERIENCE': 2737, 'EDUCATION': 6535, 'CERTIFICATIONS': 6698}` |
| `final_resume_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [2766, 2823], 'ibm': [4250, 4264], 'insurtech': [5019, 5072], 'ey': [5407, 5433], 'early_career': [6038, 6103]}}` |
| `final_resume_docx_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [2761, 2818], 'ibm': [4244, 4258], 'insurtech': [5012, 5065], 'ey': [5399, 5425], 'early_career': [6029, 6094]}}` |
| `final_resume_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6555, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 6640}}` |
| `final_resume_docx_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6545, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 6630}}` |
| `final_resume_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 6738, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 6797, 'Certified Solutions Architect – Professional, AWS, 2023': 6851, 'Fellow of the Society of Actuaries, 2010': 6907}}` |
| `final_resume_docx_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 6727, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 6786, 'Certified Solutions Architect – Professional, AWS, 2023': 6840, 'Fellow of the Society of Actuaries, 2010': 6896}}` |
...
| `ey_bullets` | `OpenAI ChatGPT` | `gpt-5.6-sol` | `MODEL_BACKED_FAIL` | 0.72 | 0.72 | `FAIL` | `decisive_judge_failures=openai_chatgpt, model_backed_pass_provider_keys=gemini_pro` |
...
- Artifact directory: `artifacts/apps_rg/runs/w8_anthropic_positive_retry16_20260809/e2e_20260809T090140Z_6b8a9546/section_failure_forensics`
...
| `ibm_bullets` | `independent_failure` | `True` | `False` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry16_20260809/e2e_20260809T090140Z_6b8a9546/section_failure_forensics/ibm_bullets.json` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry16_20260809/e2e_20260809T090140Z_6b8a9546/section_failure_forensics/ibm_bullets.md` |
| `ey_bullets` | `independent_failure` | `True` | `False` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry16_20260809/e2e_20260809T090140Z_6b8a9546/section_failure_forensics/ey_bullets.json` | `artifacts/apps_rg/runs/w8_anthropic_positive_retry16_20260809/e2e_20260809T090140Z_6b8a9546/section_failure_forensics/ey_bullets.md` |
...
run_root=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry16_20260809\e2e_20260809T090140Z_6b8a9546
status=BLOCKED
reason=outcome_authorized_false; final_resume_output_status=FAIL; failed_final_resume_gates=final_resume_no_gap_markers; x3_blocked=competencies,ibm_bullets,ey_bullets,final_resume_aggregation; pre_run_blocked=ibm_narrative,ey_narrative
