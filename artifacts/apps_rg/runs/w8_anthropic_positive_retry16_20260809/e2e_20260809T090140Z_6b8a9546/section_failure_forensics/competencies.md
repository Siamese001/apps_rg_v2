...
- failed_gate_ids: `x2_required_capability_families_covered, x2_resume_graph_claim_binding`
...
The section's final materialized artifact did not pass x2_required_capability_families_covered, x2_resume_graph_claim_binding.
...
- Bind the failed gate evidence (`x2_required_capability_families_covered, x2_resume_graph_claim_binding`) to the producer/parser contract that emitted the artifact.
