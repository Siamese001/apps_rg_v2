...
|---|---|---|---|---|---|---|
| competencies | PRE_RUN:EXECUTED_X3A | UNKNOWN | UNKNOWN | UNKNOWN | — | — (missing) |
| ↳ pre-run | | | | | | `PRE_RUN:EXECUTED_X3A` |
...
| ↳ pre-run | | | | | | `PRE_RUN:PHASE1_NO_RUN_DIR` |
| final_resume_aggregation | X3_REVIEW_AGGREGATION | UNKNOWN | UNKNOWN | ASSEMBLED | — | [modular_r4/final_resume_assembly/final_resume.json](artifacts/apps_rg/runs/s2r3_r2/e2e_20260720T220340Z_9f08d894/modular_r4/final_resume_assembly/final_resume.json) |
