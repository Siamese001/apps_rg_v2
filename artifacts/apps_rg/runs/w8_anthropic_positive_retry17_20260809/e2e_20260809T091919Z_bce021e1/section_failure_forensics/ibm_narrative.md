# Section Failure Forensics - ibm_narrative

- failure_type: `independent_failure`
- baseline_confidence: `pinned_baseline_unavailable`
- failed_gate_ids: `x2_ibm_narrative_claim_theme_coverage, x2_ibm_narrative_mechanisms_supported_by_cited_companion_bullets`
...
The section's final materialized artifact did not pass x2_ibm_narrative_claim_theme_coverage, x2_ibm_narrative_mechanisms_supported_by_cited_companion_bullets.
...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `78ea6cbfbafad08d9bf22bf5a187e6c94aecfa469baf7597a4f2eebdcfc00f1d` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry17_20260809\e2e_20260809T091919Z_bce021e1\modular_r4\sections\ibm_narrative\ibm_narrative_output.txt` |
| X2 / X3 | `NOT_OBSERVED` / `NOT_OBSERVED` | `FAIL` / `X3_BLOCK` |
| Judges | `NOT_OBSERVED` | `Google Gemini 3.6 Flash `gemini-3.6-flash`: 5/5 vs 4 PASS` |

## Required Fix

- Make `ibm_narrative` gate final displayed output, not intermediate provider output.
- Bind the failed gate evidence (`x2_ibm_narrative_claim_theme_coverage, x2_ibm_narrative_mechanisms_supported_by_cited_companion_bullets`) to the producer/parser contract that emitted the artifact.
