...
Generated: `2026-08-09T05:34:30Z`
Run root: `@C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_20260809\e2e_20260809T053429Z_09b3e7f6`
...
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 7082, 'sha256': 'aaeb2226f7c8ab8c051ab3275b4296768f1b791278be1a3e24e5c16969bb4850'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'pre_run_blocked=run_preflight']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2962, 'sha256': '11a1caf5be535acfb662d1b62602b6326c886be6567a77acf9e6a942cd8d0703'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'pre_run_blocked=run_preflight']}` |
...
| `mandatory_resume_docx_inline_json_present` | `FAIL` | `{'title': 'Resume DOCX Full Version Inline', 'text_chars': 468, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'pre_run_blocked=run_preflight']}` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 7082 | `aaeb2226f7c8ab8c051ab3275b4296768f1b791278be1a3e24e5c16969bb4850` |
...
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 2962 | `11a1caf5be535acfb662d1b62602b6326c886be6567a77acf9e6a942cd8d0703` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runs/w8_anthropic_positive_20260809/e2e_20260809T053429Z_09b3e7f6/modular_r4/final_resume_assembly/final_resume.json` |
...
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2962, 'sha256': '11a1caf5be535acfb662d1b62602b6326c886be6567a77acf9e6a942cd8d0703'}` |
...
1. `run_preflight` - Route-signing configuration ingestion failure
   ...
   - Evidence: `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_20260809\e2e_20260809T053429Z_09b3e7f6\e2e_preflight_receipt.json`
   - Causal allocation:
     ...
     - Allocation rows:
       - `External configuration ingestion` / `ROOT_CAUSE` / `100%`: The launcher process did not receive both required route-signing environment variables before canonical E2E preflight. Evidence: `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_20260809\e2e_20260809T053429Z_09b3e7f6\e2e_preflight_receipt.json`. Required work: Inject the secret and key identifier through the approved local environment boundary without persisting or printing the secret.
...
run_root=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_20260809\e2e_20260809T053429Z_09b3e7f6
status=BLOCKED
