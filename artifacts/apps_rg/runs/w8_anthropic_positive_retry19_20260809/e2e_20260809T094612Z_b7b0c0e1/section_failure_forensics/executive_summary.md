...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `87aac3e7d3769f51116c9642da6b09034e6db5a0b778f96ae18911566acde5da` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry19_20260809\e2e_20260809T094612Z_b7b0c0e1\modular_r4\sections\executive_summary\resume_display_text.txt` |
| X2 / X3 | `NOT_OBSERVED` / `NOT_OBSERVED` | `PASS` / `X3_REVIEW_JUDGE_PROVIDER_BLOCKED` |
| Judges | `NOT_OBSERVED` | `Google Gemini 3.6 Flash `gemini-3.6-flash`: 4.2/5 vs 4 PASS; OpenAI ChatGPT `gpt-5.6-sol`: —/5 vs 0.8 FAIL` |
