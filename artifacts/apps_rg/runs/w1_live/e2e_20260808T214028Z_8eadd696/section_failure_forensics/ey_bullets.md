...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `1631fc3126e3f25a9e8d675995140059ec4f4a6e06fce96dee1bb45d7d233123` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T214028Z_8eadd696\modular_r4\sections\ey_bullets\ey_bullets_output.txt` |
| X2 / X3 | `NOT_OBSERVED` / `NOT_OBSERVED` | `PASS` / `X3_BLOCK` |
| Judges | `NOT_OBSERVED` | `Google Gemini 3.6 Flash `gemini-3.6-flash`: 5/5 vs 4 PASS; Anthropic Claude `claude-sonnet-5`: 0.82/5 vs 0.72 FAIL` |
