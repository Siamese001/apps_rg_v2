...
| `mandatory_resume_text_inline_present` | `FAIL` | `{'artifact': {'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7398, 'sha256': '8bf8f246cc758c47bef3a9d6c064f269b404cd82159910346533918defc49b68'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,ibm_bullets,ey_bullets,executive_summary,headline,final_resume_aggregation', 'pre_run_blocked=ibm_narrative,ey_narrative']}` |
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 19103605, 'sha256': '9cae149fcf35d5a1a8839cdbeb2cf9bdf4c47330f5cf59c6bcc59d091ab50b09'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,ibm_bullets,ey_bullets,executive_summary,headline,final_resume_aggregation', 'pre_run_blocked=ibm_narrative,ey_narrative']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 5073, 'sha256': '8e505bf076eba57c6cf47db9dc08506f3c3b287ca9211bcf7a85318421217858'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,ibm_bullets,ey_bullets,executive_summary,headline,final_resume_aggregation', 'pre_run_blocked=ibm_narrative,ey_narrative']}` |
...
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `FAIL` | `{'required': True, 'failed_section_count': 8, 'artifact_dir': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics', 'missing_or_incomplete': [{'section_id': 'competencies', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/competencies.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/competencies.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'ibm_bullets', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ibm_bullets.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ibm_bullets.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'ey_bullets', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ey_bullets.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ey_bullets.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'ibm_narrative', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ibm_narrative.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ibm_narrative.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'upstream_cascade', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'ey_narrative', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ey_narrative.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ey_narrative.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'upstream_cascade', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'executive_summary', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/executive_summary.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/executive_summary.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'headline', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/headline.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/headline.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'final_resume_aggregation', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/final_resume_aggregation.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/final_resume_aggregation.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'aggregation_downstream', 'baseline_confidence': 'pinned_contract_invalid'}]}` |
...
|---:|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | `research_briefing_input` | `FRESH_APPS_RESEARCH` | `miss` | `skipped` | `YES` | `True` | `external_openai` | `gpt-5.6-terra` | `N/A` | `N/A` | `N/A` | `BRIEFING_PRESENT:RUN_SPECIFIC` | `N/A` | `N/A` | `N/A` | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>PASS; judge=gemini-3.6-flash</code></span> | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>X3D_ALLOW_FINISH; X1=PASS</code></span> | <span style="display:inline-block; min-width:44ch; white-space:normal"><code>auto_research_internal=True; research_delegation_executed=True; source=RUN_SPECIFIC; digest=fda43858cf4cbb4a40ba2c9c60606a4e796444660b96dffb405776be8a9b2529;<br>ref=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T214028Z_8eadd696\apps_research\runs\bridge_rg_research_bridge_8f97ab9b_3da2370b-f1ae-4a16-955c-b48ffc256ab3\briefing.md;<br>target=Anthropic / Manager of Applied AI Architecture, Partnerships; briefing_text_chars=7946</code></span> | `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T214028Z_8eadd696\apps_research\runs\bridge_rg_research_bridge_8f97ab9b_3da2370b-f1ae-4a16-955c-b48ffc256ab3\briefing.md` | `N/A` |
...
| `executive_summary` | `ran_real_llm` | `X3_BLOCK` | `FAIL` | `FAIL` | `REAL_LLM` | `x2_exec_summary_c03_selected_fact_ids_claimable_subset_allowed_fact_ids, x2_resume_graph_claim_binding` | `modular_r4/sections/executive_summary/resume_display_text.txt` |
| `headline` | `ran_real_llm` | `X3_BLOCK` | `FAIL` | `FAIL` | `REAL_LLM` | `x2_headline_executive_abstraction_floor, x2_headline_xyz_literal_grounding` | `modular_r4/sections/headline/headline_output.txt` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 19103605 | `9cae149fcf35d5a1a8839cdbeb2cf9bdf4c47330f5cf59c6bcc59d091ab50b09` |
| Rendered final resume text | `FINAL_RESUME_OUTPUT.txt` | `EXISTS_UNAUTHORIZED` | 7398 | `8bf8f246cc758c47bef3a9d6c064f269b404cd82159910346533918defc49b68` |
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 5073 | `8e505bf076eba57c6cf47db9dc08506f3c3b287ca9211bcf7a85318421217858` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/modular_r4/final_resume_assembly/final_resume.json` |
| `final_resume_rendered_text_present` | `PASS` | `{'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7398, 'sha256': '8bf8f246cc758c47bef3a9d6c064f269b404cd82159910346533918defc49b68'}` |
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 5073, 'sha256': '8e505bf076eba57c6cf47db9dc08506f3c3b287ca9211bcf7a85318421217858'}` |
| `final_resume_rendered_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 243, 'ENGINEERING & PLATFORM COMPETENCIES': 1292, 'PROFESSIONAL EXPERIENCE': 3063, 'EDUCATION': 6821, 'CERTIFICATIONS': 6985}` |
| `final_resume_docx_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 241, 'ENGINEERING & PLATFORM COMPETENCIES': 1289, 'PROFESSIONAL EXPERIENCE': 3059, 'EDUCATION': 6811, 'CERTIFICATIONS': 6974}` |
| `final_resume_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [3088, 3145], 'ibm': [4561, 4575], 'insurtech': [5195, 5248], 'ey': [5683, 5709], 'early_career': [6314, 6379]}}` |
| `final_resume_docx_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [3083, 3140], 'ibm': [4555, 4569], 'insurtech': [5188, 5241], 'ey': [5675, 5701], 'early_career': [6305, 6370]}}` |
| `final_resume_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6831, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 6916}}` |
| `final_resume_docx_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6821, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 6906}}` |
| `final_resume_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 7014, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 7073, 'Certified Solutions Architect – Professional, AWS, 2023': 7127, 'Fellow of the Society of Actuaries, 2010': 7183}}` |
| `final_resume_docx_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 7003, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 7062, 'Certified Solutions Architect – Professional, AWS, 2023': 7116, 'Fellow of the Society of Actuaries, 2010': 7172}}` |
...
| `ey_bullets` | `Anthropic Claude` | `claude-sonnet-5` | `MODEL_BACKED_FAIL` | 0.82 | 0.72 | `FAIL` | `decisive_judge_failures=anthropic_claude, model_backed_pass_provider_keys=gemini_pro` |
...
| `headline` | `OpenAI ChatGPT` | `gpt-5.6-sol` | `MODEL_BACKED_FAIL` | 2.7 | 4 | `FAIL` | `decisive_judge_failures=openai_chatgpt, model_backed_pass_provider_keys=gemini_pro` |
...
- Artifact directory: `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics`
- Baseline confidence: `pinned_contract_invalid`

| Section | Failure type | Complete | Comparison | JSON | MD |
|---|---|---:|---:|---|---|
| `competencies` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/competencies.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/competencies.md` |
| `ibm_bullets` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ibm_bullets.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ibm_bullets.md` |
| `ey_bullets` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ey_bullets.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ey_bullets.md` |
| `ibm_narrative` | `upstream_cascade` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ibm_narrative.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ibm_narrative.md` |
| `ey_narrative` | `upstream_cascade` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ey_narrative.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/ey_narrative.md` |
| `executive_summary` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/executive_summary.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/executive_summary.md` |
| `headline` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/headline.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/headline.md` |
| `final_resume_aggregation` | `aggregation_downstream` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/final_resume_aggregation.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T214028Z_8eadd696/section_failure_forensics/final_resume_aggregation.md` |
...
run_root=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T214028Z_8eadd696
status=BLOCKED
