...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `cae9319492c38d3910114852e82fb4795e37e994fd555898e50b6d3c9ac71afc` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T204928Z_e248b8bf\modular_r4\sections\insurtech_bullets\insurtech_bullets_output.txt` |
| X2 / X3 | `NOT_OBSERVED` / `NOT_OBSERVED` | `PASS` / `X3_REVIEW_JUDGE_PROVIDER_BLOCKED` |
| Judges | `NOT_OBSERVED` | `Google Gemini 3.6 Flash `gemini-3.6-flash`: —/5 vs 0.8 FAIL; Anthropic Claude `claude-sonnet-5`: 0.8/5 vs 0.72 PASS` |

## Required Fix

- Make `insurtech_bullets` gate final displayed output, not intermediate provider output.
