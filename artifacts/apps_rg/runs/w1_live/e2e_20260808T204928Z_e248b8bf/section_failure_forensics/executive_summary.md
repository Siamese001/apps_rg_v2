...
- failed_gate_ids: `x2_exec_summary_c03_selected_fact_ids_claimable_subset_allowed_fact_ids, x2_exec_summary_no_mechanism_inventory`
...
The section's final materialized artifact did not pass x2_exec_summary_c03_selected_fact_ids_claimable_subset_allowed_fact_ids, x2_exec_summary_no_mechanism_inventory.
...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `4333cad708c1354599ffd2bc63783832e745dac3c2691538ed28f4796a49efe5` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T204928Z_e248b8bf\modular_r4\sections\executive_summary\resume_display_text.txt` |
...
- Bind the failed gate evidence (`x2_exec_summary_c03_selected_fact_ids_claimable_subset_allowed_fact_ids, x2_exec_summary_no_mechanism_inventory`) to the producer/parser contract that emitted the artifact.
