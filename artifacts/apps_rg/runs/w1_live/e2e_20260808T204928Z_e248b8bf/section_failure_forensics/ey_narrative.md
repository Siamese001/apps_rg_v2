...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `35629df7deadb5b78ef431802ca3d1463397961d9797b19e3defca955c0dd520` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T204928Z_e248b8bf\modular_r4\sections\ey_narrative\ey_narrative_output.txt` |
| X2 / X3 | `NOT_OBSERVED` / `NOT_OBSERVED` | `PASS` / `X3_REVIEW_JUDGE_PROVIDER_BLOCKED` |
| Judges | `NOT_OBSERVED` | `Google Gemini 3.6 Flash `gemini-3.6-flash`: —/5 vs 0.8 FAIL` |

## Required Fix

- Make `ey_narrative` gate final displayed output, not intermediate provider output.
