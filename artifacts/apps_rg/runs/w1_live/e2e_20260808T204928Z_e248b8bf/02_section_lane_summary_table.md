...
| Fault | `L2_EXECUTION_ERROR:RuntimeError:FAILED_MODULAR_R4: decisive='FAIL' failure='fatal_lane_recipe_policy:competencies:EXECUTED_X3_BLOCK; unify_bullets:EXECUTED_X3_BLOCK; ibm_bullets:EXECUTED_X3_BLOCK; unify_narrative:upstream_not_finalized; ibm_narrative:upstream_not_finalized; executive_summary:EXECUTED_X3A_DENY_REROUTE; headline:PHASE1_NO_RUN_DIR' schema_ok=False lane_ok=False` |
...
| `mandatory_resume_text_inline_present` | `FAIL` | `{'artifact': {'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7252, 'sha256': '8b3dc2d2f45e41b14fa0d3b9a32d6eb59e3a161476b226bb35efc6de50c9aadd'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,unify_bullets,ibm_bullets,executive_summary,final_resume_aggregation', 'pre_run_blocked=unify_narrative,ibm_narrative,headline', 'unknown=insurtech_bullets,ey_bullets,insurtech_narrative,ey_narrative']}` |
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 19163808, 'sha256': '9dd623d13c080aacc3c384404be530b186d9a8833f1b20bfa06410c7ef3e8bcf'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,unify_bullets,ibm_bullets,executive_summary,final_resume_aggregation', 'pre_run_blocked=unify_narrative,ibm_narrative,headline', 'unknown=insurtech_bullets,ey_bullets,insurtech_narrative,ey_narrative']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 4940, 'sha256': '6dadf5bfe902e794a17a9d0e313c746c1b59e143f5075d6c49d4bbb91153e182'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=competencies,unify_bullets,ibm_bullets,executive_summary,final_resume_aggregation', 'pre_run_blocked=unify_narrative,ibm_narrative,headline', 'unknown=insurtech_bullets,ey_bullets,insurtech_narrative,ey_narrative']}` |
...
| `mandatory_bcg_p0_p1_px_recommendations_locked` | `FAIL` | `{'title': 'BCG Executive Output - apps_rg Run', 'section_order': ['executive_answer', 'p0_p1_px_recommendations', 'board_level_readout', 'issue_tree', 'recommended_next_move', 'evidence_map'], 'priorities': ['P0', 'P1'], 'truth_errors': ['bcg.forensics.incomplete_artifact:competencies', 'bcg.forensics.incomplete_artifact:executive_summary', 'bcg.forensics.incomplete_artifact:ey_bullets', 'bcg.forensics.incomplete_artifact:ey_narrative', 'bcg.forensics.incomplete_artifact:final_resume_aggregation', 'bcg.forensics.incomplete_artifact:headline', 'bcg.forensics.incomplete_artifact:ibm_bullets', 'bcg.forensics.incomplete_artifact:ibm_narrative', 'bcg.forensics.incomplete_artifact:insurtech_bullets', 'bcg.forensics.incomplete_artifact:insurtech_narrative', 'bcg.forensics.incomplete_artifact:unify_bullets', 'bcg.forensics.incomplete_artifact:unify_narrative', 'bcg.issue_tree.incomplete_forensic_artifact:competencies', 'bcg.issue_tree.incomplete_forensic_artifact:unify_bullets', 'bcg.issue_tree.incomplete_forensic_artifact:ibm_bullets', 'bcg.issue_tree.incomplete_forensic_artifact:unify_narrative', 'bcg.issue_tree.incomplete_forensic_artifact:ibm_narrative', 'bcg.issue_tree.incomplete_forensic_artifact:executive_summary', 'bcg.issue_tree.incomplete_forensic_artifact:headline']}` |
...
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `FAIL` | `{'required': True, 'failed_section_count': 12, 'artifact_dir': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics', 'missing_or_incomplete': [{'section_id': 'competencies', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/competencies.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/competencies.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'unify_bullets', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/unify_bullets.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/unify_bullets.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'ibm_bullets', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ibm_bullets.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ibm_bullets.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'insurtech_bullets', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/insurtech_bullets.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/insurtech_bullets.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'ey_bullets', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ey_bullets.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ey_bullets.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'unify_narrative', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/unify_narrative.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/unify_narrative.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'upstream_cascade', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'ibm_narrative', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ibm_narrative.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ibm_narrative.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'upstream_cascade', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'insurtech_narrative', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/insurtech_narrative.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/insurtech_narrative.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'ey_narrative', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ey_narrative.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ey_narrative.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'executive_summary', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/executive_summary.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/executive_summary.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'independent_failure', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'headline', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/headline.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/headline.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'upstream_cascade', 'baseline_confidence': 'pinned_contract_invalid'}, {'section_id': 'final_resume_aggregation', 'json_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/final_resume_aggregation.json', 'md_path': 'artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/final_resume_aggregation.md', 'complete': False, 'errors': ['invalid:comparison_incomplete'], 'failure_type': 'aggregation_downstream', 'baseline_confidence': 'pinned_contract_invalid'}]}` |
...
|---:|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 0 | `research_briefing_input` | `FRESH_APPS_RESEARCH` | `miss` | `skipped` | `YES` | `True` | `external_openai` | `gpt-5.6-terra` | `N/A` | `N/A` | `N/A` | `BRIEFING_PRESENT:RUN_SPECIFIC` | `N/A` | `N/A` | `N/A` | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>PASS; judge=gemini-3.6-flash</code></span> | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>X3D_ALLOW_FINISH; X1=PASS</code></span> | <span style="display:inline-block; min-width:44ch; white-space:normal"><code>auto_research_internal=True; research_delegation_executed=True; source=RUN_SPECIFIC; digest=5ddc4416644a2a9d69205d6a26d51452fb90a95de7ee5b12f1fc5e55f54c00a6;<br>ref=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T204928Z_e248b8bf\apps_research\runs\bridge_rg_research_bridge_d3f29352_8bc5b71d-03ec-4c41-a003-6f4aad5b5b5d\briefing.md;<br>target=Anthropic / Manager of Applied AI Architecture, Partnerships; briefing_text_chars=6790</code></span> | `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T204928Z_e248b8bf\apps_research\runs\bridge_rg_research_bridge_d3f29352_8bc5b71d-03ec-4c41-a003-6f4aad5b5b5d\briefing.md` | `N/A` |
...
| 2 | `unify_bullets` | `N/A` | `miss` | `skipped` | `YES` | `True` | `external_claude` | `claude-sonnet-5` | `NOT_OBSERVED` | `NOT_OBSERVED` | `NOT_OBSERVED` | `REAL_LLM` | `YES` | `Google Gemini 3.6 Flash / gemini-3.6-flash: 3 vs 4 FAIL; Anthropic Claude / claude-sonnet-5: 0.76 vs 0.72 PASS; Google Gemini 3.6 Flash / gemini-3.6-flash: 5 vs 4 PASS` | `decisive_judge_failures=gemini_pro` | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>PASS</code></span> | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>X3_BLOCK</code></span> | <span style="display:inline-block; min-width:44ch; white-space:normal"><code>X1D decisive judge failure: model-backed judge rejected section product quality.</code></span> | `modular_r4/sections/unify_bullets/unify_bullets_output.txt` | `future_run_advisory_only` |
...
| 4 | `insurtech_bullets` | `N/A` | `miss` | `skipped` | `YES` | `True` | `external_claude` | `claude-sonnet-5` | `NOT_OBSERVED` | `NOT_OBSERVED` | `NOT_OBSERVED` | `REAL_LLM` | `YES` | `Google Gemini 3.6 Flash / gemini-3.6-flash: - vs 0.8 FAIL; Anthropic Claude / claude-sonnet-5: 0.8 vs 0.72 PASS` | `blocked_judges=gemini_pro` | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>PASS</code></span> | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>X3_REVIEW_JUDGE_PROVIDER_BLOCKED</code></span> | <span style="display:inline-block; min-width:44ch; white-space:normal"><code>No section-level failure recorded.</code></span> | `modular_r4/sections/insurtech_bullets/insurtech_bullets_output.txt` | `future_run_advisory_only` |
| 5 | `ey_bullets` | `N/A` | `miss` | `skipped` | `YES` | `True` | `external_claude` | `claude-sonnet-5` | `NOT_OBSERVED` | `NOT_OBSERVED` | `NOT_OBSERVED` | `REAL_LLM` | `YES` | `Google Gemini 3.6 Flash / gemini-3.6-flash: - vs 0.8 FAIL; Anthropic Claude / claude-sonnet-5: 0.81 vs 0.72 PASS` | `blocked_judges=gemini_pro` | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>PASS</code></span> | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>X3_REVIEW_JUDGE_PROVIDER_BLOCKED</code></span> | <span style="display:inline-block; min-width:44ch; white-space:normal"><code>No section-level failure recorded.</code></span> | `modular_r4/sections/ey_bullets/ey_bullets_output.txt` | `future_run_advisory_only` |
...
| 8 | `insurtech_narrative` | `N/A` | `miss` | `skipped` | `YES` | `True` | `external_openai` | `gpt-5.6-luna` | `N/A` | `NOT_OBSERVED` | `NOT_OBSERVED` | `REAL_LLM` | `YES` | `Google Gemini 3.6 Flash / gemini-3.6-flash: - vs 0.8 FAIL` | `blocked_judges=gemini_pro` | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>PASS</code></span> | <span style="display:inline-block; min-width:32ch; white-space:normal"><code>X3_REVIEW_JUDGE_PROVIDER_BLOCKED</code></span> | <span style="display:inline-block; min-width:44ch; white-space:normal"><code>No section-level failure recorded.</code></span> | `modular_r4/sections/insurtech_narrative/insurtech_narrative_output.txt` | `future_run_advisory_only` |
...
| `unify_bullets` | `ran_real_llm` | `X3_BLOCK` | `PASS` | `PASS` | `REAL_LLM` | `-` | `modular_r4/sections/unify_bullets/unify_bullets_output.txt` |
...
| `insurtech_bullets` | `ran_real_llm` | `X3_REVIEW_JUDGE_PROVIDER_BLOCKED` | `PASS` | `PASS` | `REAL_LLM` | `-` | `modular_r4/sections/insurtech_bullets/insurtech_bullets_output.txt` |
| `ey_bullets` | `ran_real_llm` | `X3_REVIEW_JUDGE_PROVIDER_BLOCKED` | `PASS` | `PASS` | `REAL_LLM` | `-` | `modular_r4/sections/ey_bullets/ey_bullets_output.txt` |
...
| `insurtech_narrative` | `ran_real_llm` | `X3_REVIEW_JUDGE_PROVIDER_BLOCKED` | `PASS` | `PASS` | `REAL_LLM` | `-` | `modular_r4/sections/insurtech_narrative/insurtech_narrative_output.txt` |
| `ey_narrative` | `ran_real_llm` | `X3_REVIEW_JUDGE_PROVIDER_BLOCKED` | `PASS` | `PASS` | `REAL_LLM` | `-` | `modular_r4/sections/ey_narrative/ey_narrative_output.txt` |
| `executive_summary` | `ran_real_llm` | `X3_BLOCK` | `FAIL` | `FAIL` | `REAL_LLM` | `x2_exec_summary_c03_selected_fact_ids_claimable_subset_allowed_fact_ids, x2_exec_summary_no_mechanism_inventory` | `modular_r4/sections/executive_summary/resume_display_text.txt` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 19163808 | `9dd623d13c080aacc3c384404be530b186d9a8833f1b20bfa06410c7ef3e8bcf` |
| Rendered final resume text | `FINAL_RESUME_OUTPUT.txt` | `EXISTS_UNAUTHORIZED` | 7252 | `8b3dc2d2f45e41b14fa0d3b9a32d6eb59e3a161476b226bb35efc6de50c9aadd` |
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 4940 | `6dadf5bfe902e794a17a9d0e313c746c1b59e143f5075d6c49d4bbb91153e182` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/modular_r4/final_resume_assembly/final_resume.json` |
| `final_resume_rendered_text_present` | `PASS` | `{'relpath': 'FINAL_RESUME_OUTPUT.txt', 'exists': True, 'bytes': 7252, 'sha256': '8b3dc2d2f45e41b14fa0d3b9a32d6eb59e3a161476b226bb35efc6de50c9aadd'}` |
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 4940, 'sha256': '6dadf5bfe902e794a17a9d0e313c746c1b59e143f5075d6c49d4bbb91153e182'}` |
| `final_resume_rendered_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 182, 'ENGINEERING & PLATFORM COMPETENCIES': 1174, 'PROFESSIONAL EXPERIENCE': 2945, 'EDUCATION': 6673, 'CERTIFICATIONS': 6837}` |
| `final_resume_docx_order_valid` | `PASS` | `{'EXECUTIVE SUMMARY': 180, 'ENGINEERING & PLATFORM COMPETENCIES': 1171, 'PROFESSIONAL EXPERIENCE': 2941, 'EDUCATION': 6663, 'CERTIFICATIONS': 6826}` |
| `final_resume_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [2970, 3027], 'ibm': [4243, 4257], 'insurtech': [4877, 4930], 'ey': [5365, 5391], 'early_career': [6166, 6231]}}` |
| `final_resume_docx_base_role_headers_preserved` | `PASS` | `{'role_headers': {'unify': ['Unify Consulting — SVP Engineering, Agentic AI Platforms', 'Boca Raton, FL \| Feb 2023 – Present'], 'ibm': ['IBM — Partner', 'Edgewater, NJ \| Apr 2017 – Oct 2022'], 'insurtech': ['InsurTech Cloud Solutions — Chief Technology Officer', 'New York, NY \| Apr 2014 – Mar 2017'], 'ey': ['Ernst & Young — Principal', 'New York, NY \| Oct 2009 – Mar 2014'], 'early_career': ['Early Career Roles — Actuarial Consultant and Quantitative Roles', 'Philadelphia, PA \| Oct 2002 – Sep 2009']}, 'positions': {'unify': [2965, 3022], 'ibm': [4237, 4251], 'insurtech': [4870, 4923], 'ey': [5357, 5383], 'early_career': [6157, 6222]}}` |
| `final_resume_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6683, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 6768}}` |
| `final_resume_docx_education_copied_from_base` | `PASS` | `{'section_id': 'education', 'expected_lines': ['Master of Science in Biostatistics, Columbia University (Graduated with Distinction)', 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)'], 'positions': {'Master of Science in Biostatistics, Columbia University (Graduated with Distinction)': 6673, 'Bachelor of Arts in Biology, Brown University (Graduated Cum Laude)': 6758}}` |
| `final_resume_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 6866, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 6925, 'Certified Solutions Architect – Professional, AWS, 2023': 6979, 'Fellow of the Society of Actuaries, 2010': 7035}}` |
| `final_resume_docx_certifications_copied_from_base` | `PASS` | `{'section_id': 'certifications', 'expected_lines': ['Certified Machine Learning Engineer – Associate, AWS, 2025', 'Databricks Lakehouse Fundamentals Accreditation, 2023', 'Certified Solutions Architect – Professional, AWS, 2023', 'Fellow of the Society of Actuaries, 2010'], 'positions': {'Certified Machine Learning Engineer – Associate, AWS, 2025': 6855, 'Databricks Lakehouse Fundamentals Accreditation, 2023': 6914, 'Certified Solutions Architect – Professional, AWS, 2023': 6968, 'Fellow of the Society of Actuaries, 2010': 7024}}` |
...
| `unify_bullets` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `MODEL_BACKED_FAIL` | 3 | 4 | `FAIL` | `decisive_judge_failures=gemini_pro, model_backed_pass_provider_keys=anthropic_claude,gemini_pro` |
| `unify_bullets` | `Anthropic Claude` | `claude-sonnet-5` | `MODEL_BACKED_PASS` | 0.76 | 0.72 | `PASS` | `decisive_judge_failures=gemini_pro, model_backed_pass_provider_keys=anthropic_claude,gemini_pro` |
| `unify_bullets` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `MODEL_BACKED_PASS` | 5 | 4 | `PASS` | `decisive_judge_failures=gemini_pro, model_backed_pass_provider_keys=anthropic_claude,gemini_pro` |
...
| `ibm_bullets` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `MODEL_BACKED_PASS` | 5 | 4 | `PASS` | `model_backed_pass_provider_keys=gemini_pro,anthropic_claude,gemini_pro` |
| `insurtech_bullets` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `BLOCKED_TOKEN_BUDGET` | - | 0.8 | `FAIL` | `blocked_judges=gemini_pro, model_backed_pass_provider_keys=anthropic_claude` |
| `insurtech_bullets` | `Anthropic Claude` | `claude-sonnet-5` | `MODEL_BACKED_PASS` | 0.8 | 0.72 | `PASS` | `blocked_judges=gemini_pro, model_backed_pass_provider_keys=anthropic_claude` |
| `ey_bullets` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `BLOCKED_TOKEN_BUDGET` | - | 0.8 | `FAIL` | `blocked_judges=gemini_pro, model_backed_pass_provider_keys=anthropic_claude` |
| `ey_bullets` | `Anthropic Claude` | `claude-sonnet-5` | `MODEL_BACKED_PASS` | 0.81 | 0.72 | `PASS` | `blocked_judges=gemini_pro, model_backed_pass_provider_keys=anthropic_claude` |
| `unify_narrative` | `-` | `-` | `section_not_run` |  |  | `UNKNOWN` | `-` |
| `ibm_narrative` | `-` | `-` | `section_not_run` |  |  | `UNKNOWN` | `-` |
| `insurtech_narrative` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `BLOCKED_TOKEN_BUDGET` | - | 0.8 | `FAIL` | `blocked_judges=gemini_pro` |
| `ey_narrative` | `Google Gemini 3.6 Flash` | `gemini-3.6-flash` | `BLOCKED_TOKEN_BUDGET` | - | 0.8 | `FAIL` | `blocked_judges=gemini_pro` |
...
2. `unify_bullets` - X1D decisive judge failure: model-backed judge rejected section product quality.
...
7. `headline` - Pre-run dependency blocked execution: PHASE1_NO_RUN_DIR; pre_run_blocked:PHASE1_PRIOR_LANE_FAILED
   - Root cause: The lane dependency graph allows a downstream lane to be scheduled without an explicit upstream product-authorization token.
...
- Artifact directory: `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics`
- Baseline confidence: `pinned_contract_invalid`

| Section | Failure type | Complete | Comparison | JSON | MD |
|---|---|---:|---:|---|---|
| `competencies` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/competencies.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/competencies.md` |
| `unify_bullets` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/unify_bullets.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/unify_bullets.md` |
| `ibm_bullets` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ibm_bullets.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ibm_bullets.md` |
| `insurtech_bullets` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/insurtech_bullets.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/insurtech_bullets.md` |
| `ey_bullets` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ey_bullets.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ey_bullets.md` |
| `unify_narrative` | `upstream_cascade` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/unify_narrative.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/unify_narrative.md` |
| `ibm_narrative` | `upstream_cascade` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ibm_narrative.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ibm_narrative.md` |
| `insurtech_narrative` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/insurtech_narrative.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/insurtech_narrative.md` |
| `ey_narrative` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ey_narrative.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/ey_narrative.md` |
| `executive_summary` | `independent_failure` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/executive_summary.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/executive_summary.md` |
| `headline` | `upstream_cascade` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/headline.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/headline.md` |
| `final_resume_aggregation` | `aggregation_downstream` | `False` | `False` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/final_resume_aggregation.json` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T204928Z_e248b8bf/section_failure_forensics/final_resume_aggregation.md` |
...
run_root=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T204928Z_e248b8bf
status=BLOCKED
