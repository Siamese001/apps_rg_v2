...
|---|---|---|
| **HOW trace** | `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T210449Z_62899bbe\apps_rg_how_trace.json` | `PRESENT` |
| **Route-family coverage** | `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T210449Z_62899bbe\apps_rg_l7_route_family_coverage.json` | `PRESENT` |
| **Spine proof** | `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T210449Z_62899bbe\apps_rg_spine_proof.json` | `PRESENT` |
