...
Generated: `2026-08-08T20:12:01Z`
Run root: `@C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T201200Z_fd610337`
...
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 7082, 'sha256': 'd70fcad9413969fba3f86e9791f2e7f31d851278bfdf74beebece7f2d74734eb'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'pre_run_blocked=run_preflight']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2962, 'sha256': '56b9c43c57193bde3a2b047fce1319417e897f3f02709cbc1259670fd831fe80'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'pre_run_blocked=run_preflight']}` |
...
| `mandatory_resume_docx_inline_json_present` | `FAIL` | `{'title': 'Resume DOCX Full Version Inline', 'text_chars': 445, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'pre_run_blocked=run_preflight']}` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 7082 | `d70fcad9413969fba3f86e9791f2e7f31d851278bfdf74beebece7f2d74734eb` |
...
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 2962 | `56b9c43c57193bde3a2b047fce1319417e897f3f02709cbc1259670fd831fe80` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runs/w1_live/e2e_20260808T201200Z_fd610337/modular_r4/final_resume_assembly/final_resume.json` |
...
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2962, 'sha256': '56b9c43c57193bde3a2b047fce1319417e897f3f02709cbc1259670fd831fe80'}` |
...
1. `run_preflight` - Route-signing configuration ingestion failure
   ...
   - Evidence: `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T201200Z_fd610337\e2e_preflight_receipt.json`
   - Causal allocation:
     ...
     - Allocation rows:
       - `External configuration ingestion` / `ROOT_CAUSE` / `100%`: The launcher process did not receive both required route-signing environment variables before canonical E2E preflight. Evidence: `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T201200Z_fd610337\e2e_preflight_receipt.json`. Required work: Inject the secret and key identifier through the approved local environment boundary without persisting or printing the secret.
...
run_root=C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w1_live\e2e_20260808T201200Z_fd610337
status=BLOCKED
