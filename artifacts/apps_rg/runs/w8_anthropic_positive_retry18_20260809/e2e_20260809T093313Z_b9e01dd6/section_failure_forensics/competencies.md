...
- failed_gate_ids: `x2_competencies_visible_terms_svp_agentic_richness`
...
The section's final materialized artifact did not pass x2_competencies_visible_terms_svp_agentic_richness.
...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `d15a3829c5a4fd6dcef35e81a0892f4c00e23a69cea3f9f9f147c22e205331b5` / `C:\Git\apps_rg_v2-worktrees\codex-e2e-defect-remediation-w0\artifacts\apps_rg\runs\w8_anthropic_positive_retry18_20260809\e2e_20260809T093313Z_b9e01dd6\modular_r4\sections\competencies\competencies_display.txt` |
| X2 / X3 | `NOT_OBSERVED` / `NOT_OBSERVED` | `FAIL` / `X3_BLOCK` |
| Judges | `NOT_OBSERVED` | `Google Gemini 3.6 Flash `gemini-3.6-flash`: 5/5 vs 4 PASS; OpenAI ChatGPT `gpt-5.6-sol`: 4.7/5 vs 4 PASS` |

## Required Fix

- Make `competencies` gate final displayed output, not intermediate provider output.
- Bind the failed gate evidence (`x2_competencies_visible_terms_svp_agentic_richness`) to the producer/parser contract that emitted the artifact.
