...
This section did not independently certify because an upstream dependency or pre-run blocker prevented normal section authorization: Evidence mapping failure: visible content was not fully backed by source facts or graph lineage..
