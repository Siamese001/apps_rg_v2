...
| Fault | `ResumeGraphW6ReleaseAuthorityError:whole-resume graph product release authority unavailable: official_w6_artifact_missing; trusted_w6_receipt_sha256_missing; trusted_w6_full_report_sha256_missing` |
...
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 6988, 'sha256': 'a17679d342c96cb7fc914ea32cd5b6940897d56c62b5c4bc46bc04d5aa601125'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=final_resume_aggregation', 'not_run=competencies,unify_bullets,ibm_bullets,insurtech_bullets,ey_bullets,unify_narrative,ibm_narrative,insurtech_narrative,ey_narrative,executive_summary,headline']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2948, 'sha256': '522519f7e34b960305913a7802fdd9214d94684ea9fd1565bd7f642dca038f96'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'x3_blocked=final_resume_aggregation', 'not_run=competencies,unify_bullets,ibm_bullets,insurtech_bullets,ey_bullets,unify_narrative,ibm_narrative,insurtech_narrative,ey_narrative,executive_summary,headline']}` |
...
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `PASS` | `{'required': True, 'failed_section_count': 12, 'artifact_dir': 'artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics', 'missing_or_incomplete': []}` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 6988 | `a17679d342c96cb7fc914ea32cd5b6940897d56c62b5c4bc46bc04d5aa601125` |
...
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 2948 | `522519f7e34b960305913a7802fdd9214d94684ea9fd1565bd7f642dca038f96` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/modular_r4/final_resume_assembly/final_resume.json` |
...
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2948, 'sha256': '522519f7e34b960305913a7802fdd9214d94684ea9fd1565bd7f642dca038f96'}` |
...
- Artifact directory: `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics`
- Baseline confidence: `pinned_contract_invalid`

| Section | Failure type | Complete | Comparison | JSON | MD |
|---|---|---:|---:|---|---|
| `competencies` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/competencies.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/competencies.md` |
| `unify_bullets` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/unify_bullets.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/unify_bullets.md` |
| `ibm_bullets` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/ibm_bullets.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/ibm_bullets.md` |
| `insurtech_bullets` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/insurtech_bullets.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/insurtech_bullets.md` |
| `ey_bullets` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/ey_bullets.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/ey_bullets.md` |
| `unify_narrative` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/unify_narrative.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/unify_narrative.md` |
| `ibm_narrative` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/ibm_narrative.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/ibm_narrative.md` |
| `insurtech_narrative` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/insurtech_narrative.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/insurtech_narrative.md` |
| `ey_narrative` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/ey_narrative.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/ey_narrative.md` |
| `executive_summary` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/executive_summary.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/executive_summary.md` |
| `headline` | `upstream_cascade` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/headline.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/headline.md` |
| `final_resume_aggregation` | `aggregation_downstream` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/final_resume_aggregation.json` | `artifacts/apps_rg/runtime_proofs/full_resume_7f2d6acf719f/section_failure_forensics/final_resume_aggregation.md` |
...
run_root=C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_7f2d6acf719f
status=BLOCKED
