...
Generated: `2026-08-16T15:42:27Z`
Run root: `@C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_6bae17946236`
...
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 6988, 'sha256': 'f17522f2b88f50b7fe4b62d90d6a417859a5f6f7f77f03899cbbbd0b04c716a0'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2948, 'sha256': 'c8abf5243983264a679ccb81de3fb1992279a708b4a4309d71d3c707588929c7'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers']}` |
...
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `PASS` | `{'required': True, 'failed_section_count': 1, 'artifact_dir': 'artifacts/apps_rg/runtime_proofs/full_resume_6bae17946236/section_failure_forensics', 'missing_or_incomplete': []}` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 6988 | `f17522f2b88f50b7fe4b62d90d6a417859a5f6f7f77f03899cbbbd0b04c716a0` |
...
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 2948 | `c8abf5243983264a679ccb81de3fb1992279a708b4a4309d71d3c707588929c7` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runtime_proofs/full_resume_6bae17946236/modular_r4/final_resume_assembly/final_resume.json` |
...
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2948, 'sha256': 'c8abf5243983264a679ccb81de3fb1992279a708b4a4309d71d3c707588929c7'}` |
...
- Artifact directory: `artifacts/apps_rg/runtime_proofs/full_resume_6bae17946236/section_failure_forensics`
- Baseline confidence: `pinned_contract_invalid`

| Section | Failure type | Complete | Comparison | JSON | MD |
|---|---|---:|---:|---|---|
| `whole_run` | `mandatory_output_authorization_block` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_6bae17946236/section_failure_forensics/whole_run.json` | `artifacts/apps_rg/runtime_proofs/full_resume_6bae17946236/section_failure_forensics/whole_run.md` |
...
run_root=C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_6bae17946236
status=BLOCKED
