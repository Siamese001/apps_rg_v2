...
- failed_gate_ids: `x2_exec_summary_allowed_fact_utilization, x2_exec_summary_no_mechanism_inventory`
...
The section's final materialized artifact did not pass x2_exec_summary_allowed_fact_utilization, x2_exec_summary_no_mechanism_inventory.
...
| Materialized output | `NOT_OBSERVED` / `NOT_OBSERVED` | `58a7ca1606d958665f253904e002611585cf04275838957e104b63afa99751d4` / `C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_bb83a0b3333f\lanes\executive_summary\resume_display_text.txt` |
...
- Bind the failed gate evidence (`x2_exec_summary_allowed_fact_utilization, x2_exec_summary_no_mechanism_inventory`) to the producer/parser contract that emitted the artifact.
