...
|---:|---|---|---|---|---|---|---|---|
| 1 | `u0_ingress` | `NOT_OBSERVED` | `168f4c06ff6ce9103a2e226a` | `False` | `CORRELATED_ONLY` | The runs differ here, but the available artifacts do not prove this targeting change caused the failed sentence shape. | `-` | `C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_eec64f4d7ffc\ingress_raw.json` |
| 2 | `u0_payload` | `NOT_OBSERVED` | `d5144e1c2f24c0b173fe58f2` | `False` | `CORRELATED_ONLY` | The runs differ here, but the available artifacts do not prove this targeting change caused the failed sentence shape. | `-` | `C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_eec64f4d7ffc\u0_receipt.json` |
