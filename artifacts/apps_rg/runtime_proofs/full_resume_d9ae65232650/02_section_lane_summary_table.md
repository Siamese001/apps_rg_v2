...
Generated: `2026-08-16T15:45:06Z`
Run root: `@C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_d9ae65232650`
...
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 6988, 'sha256': '49ecf1ec905ffca1521c07d1a2cd9867c717076d1d3dae61ae687fffabf4629d'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2948, 'sha256': 'b8def5ce7c976515148f50ee5c373bf13004e3345165c1a9bfc61ca58061a60d'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers']}` |
...
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `PASS` | `{'required': True, 'failed_section_count': 1, 'artifact_dir': 'artifacts/apps_rg/runtime_proofs/full_resume_d9ae65232650/section_failure_forensics', 'missing_or_incomplete': []}` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 6988 | `49ecf1ec905ffca1521c07d1a2cd9867c717076d1d3dae61ae687fffabf4629d` |
...
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 2948 | `b8def5ce7c976515148f50ee5c373bf13004e3345165c1a9bfc61ca58061a60d` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runtime_proofs/full_resume_d9ae65232650/modular_r4/final_resume_assembly/final_resume.json` |
...
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2948, 'sha256': 'b8def5ce7c976515148f50ee5c373bf13004e3345165c1a9bfc61ca58061a60d'}` |
...
- Artifact directory: `artifacts/apps_rg/runtime_proofs/full_resume_d9ae65232650/section_failure_forensics`
- Baseline confidence: `pinned_contract_invalid`

| Section | Failure type | Complete | Comparison | JSON | MD |
|---|---|---:|---:|---|---|
| `whole_run` | `mandatory_output_authorization_block` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_d9ae65232650/section_failure_forensics/whole_run.json` | `artifacts/apps_rg/runtime_proofs/full_resume_d9ae65232650/section_failure_forensics/whole_run.md` |
...
run_root=C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_d9ae65232650
status=BLOCKED
