...
Generated: `2026-08-08T00:56:21Z`
Run root: `@C:\Git\apps_rg_v2-worktrees\main-publication\artifacts\apps_rg\runtime_proofs\full_resume_8b656bbf38a5`
...
| `mandatory_resume_docx_inline_json_present` | `FAIL` | `{'title': 'Resume DOCX Full Version Inline', 'text_chars': 427, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers', 'pre_run_blocked=run_preflight']}` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 7067 | `52f04c0ed071a4963c80e9e59baad978d61fe56dce95da6432f3d2e191f3e394` |
...
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 2962 | `6a1f1ee09e1c1695786b1eb00c661f72d4c420607b707d560f699cb2508d9d38` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runtime_proofs/full_resume_8b656bbf38a5/modular_r4/final_resume_assembly/final_resume.json` |
...
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2962, 'sha256': '6a1f1ee09e1c1695786b1eb00c661f72d4c420607b707d560f699cb2508d9d38'}` |
...
1. `run_preflight` - Route-signing configuration ingestion failure
   ...
   - Evidence: `C:\Git\apps_rg_v2-worktrees\main-publication\artifacts\apps_rg\runtime_proofs\full_resume_8b656bbf38a5\e2e_preflight_receipt.json`
   - Causal allocation:
     ...
     - Allocation rows:
       - `External configuration ingestion` / `ROOT_CAUSE` / `100%`: The launcher process did not receive both required route-signing environment variables before canonical E2E preflight. Evidence: `C:\Git\apps_rg_v2-worktrees\main-publication\artifacts\apps_rg\runtime_proofs\full_resume_8b656bbf38a5\e2e_preflight_receipt.json`. Required work: Inject the secret and key identifier through the approved local environment boundary without persisting or printing the secret.
...
run_root=C:\Git\apps_rg_v2-worktrees\main-publication\artifacts\apps_rg\runtime_proofs\full_resume_8b656bbf38a5
status=BLOCKED
