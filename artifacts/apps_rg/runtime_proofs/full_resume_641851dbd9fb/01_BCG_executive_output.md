...
The run is blocked and must not authorize a final resume. Required generation and/or final product gates did not clear. The source X3 decision was X3_BLOCK, but completion ended BLOCKED because U0_REJECTED:FIELD_TYPE_MISMATCH. Use the P0/P1/PX recommendations below as the repair order.
...
- Mandatory run ledger: `@C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_641851dbd9fb\02_section_lane_summary_table.md`
- Machine-readable ledger: `@C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_641851dbd9fb\APPS_RG_MANDATORY_RUN_OUTPUT.json`
- Final resume text: `@C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_641851dbd9fb\FINAL_RESUME_OUTPUT.txt`
- Final resume output contract: `@C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_641851dbd9fb\FINAL_RESUME_OUTPUT.json`
- Resume DOCX: `@C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_641851dbd9fb\outputs/resume.docx`
- Section failure forensics index: `@artifacts/apps_rg/runtime_proofs/full_resume_641851dbd9fb/section_failure_forensics/index.json; @artifacts/apps_rg/runtime_proofs/full_resume_641851dbd9fb/section_failure_forensics/index.md`
- Section forensic RCA: whole_run: `@artifacts/apps_rg/runtime_proofs/full_resume_641851dbd9fb/section_failure_forensics/whole_run.json; @artifacts/apps_rg/runtime_proofs/full_resume_641851dbd9fb/section_failure_forensics/whole_run.md`
