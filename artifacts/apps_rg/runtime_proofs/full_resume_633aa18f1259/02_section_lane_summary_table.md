...
Generated: `2026-08-16T15:49:58Z`
Run root: `@C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_633aa18f1259`
...
| Fault | `APPS_RESEARCH_ROUTE_MISMATCH` |
...
| `mandatory_final_resume_json_present` | `FAIL` | `{'artifact': {'relpath': 'modular_r4/final_resume_assembly/final_resume.json', 'exists': True, 'bytes': 6988, 'sha256': '11fb5f18af1dc48af07f0675ae4b979a41b3ac5daf4c3d87a4350a771c08894e'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers']}` |
| `mandatory_resume_docx_present` | `FAIL` | `{'artifact': {'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2948, 'sha256': '2b0645db0250f780db237559ead1b0d21ecfeecfe7cd9ed504ab0ac627b4c968'}, 'current_run_authorized': False, 'blockers': ['outcome_authorized_false', 'final_resume_output_status=FAIL', 'failed_final_resume_gates=final_resume_no_gap_markers']}` |
...
| `E2E_FAIL_WITHOUT_SECTION_FORENSICS` | `PASS` | `{'required': True, 'failed_section_count': 1, 'artifact_dir': 'artifacts/apps_rg/runtime_proofs/full_resume_633aa18f1259/section_failure_forensics', 'missing_or_incomplete': []}` |
...
|---|---|---|---:|---|
| Canonical final resume JSON | `modular_r4/final_resume_assembly/final_resume.json` | `EXISTS_UNAUTHORIZED` | 6988 | `11fb5f18af1dc48af07f0675ae4b979a41b3ac5daf4c3d87a4350a771c08894e` |
...
| Final resume DOCX | `outputs/resume.docx` | `EXISTS_UNAUTHORIZED` | 2948 | `2b0645db0250f780db237559ead1b0d21ecfeecfe7cd9ed504ab0ac627b4c968` |

| Gate | Status | Observed |
|---|---|---|
| `final_resume_json_spine_present` | `PASS` | `artifacts/apps_rg/runtime_proofs/full_resume_633aa18f1259/modular_r4/final_resume_assembly/final_resume.json` |
...
| `final_resume_docx_present_nonempty` | `PASS` | `{'relpath': 'outputs/resume.docx', 'exists': True, 'bytes': 2948, 'sha256': '2b0645db0250f780db237559ead1b0d21ecfeecfe7cd9ed504ab0ac627b4c968'}` |
...
- Artifact directory: `artifacts/apps_rg/runtime_proofs/full_resume_633aa18f1259/section_failure_forensics`
- Baseline confidence: `pinned_contract_invalid`

| Section | Failure type | Complete | Comparison | JSON | MD |
|---|---|---:|---:|---|---|
| `whole_run` | `mandatory_output_authorization_block` | `True` | `False` | `artifacts/apps_rg/runtime_proofs/full_resume_633aa18f1259/section_failure_forensics/whole_run.json` | `artifacts/apps_rg/runtime_proofs/full_resume_633aa18f1259/section_failure_forensics/whole_run.md` |
...
run_root=C:\Git\apps_rg_v2\artifacts\apps_rg\runtime_proofs\full_resume_633aa18f1259
status=BLOCKED
