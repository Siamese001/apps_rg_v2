...
JUDGE_RUBRIC_VERSION = "ibm_bullets_x1d_v4"
JUDGE_RUBRIC_REF = "apps_rg/runtime/judges/employment_bullet_judge_rubric.py#ibm_bullets"

IBM_RUBRIC = grade_only_rubric_text(
    "ibm_bullets",
    bullet_count=5,
    bullet_id_range="bul_ibm_001..005",
)
